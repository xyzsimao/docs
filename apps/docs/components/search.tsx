...
const items = [
  ...
  {
    name: 'UI',
    description: 'Only results about xyzdocs UI',
    value: 'ui',
  },
  {
    name: 'Core',
    description: 'Only results about xyzdocs Core',
    value: 'headless',
  },
  {
    name: 'MDX',
    description: 'Only results about xyzdocs MDX',
    value: 'mdx',
  },
  {
    name: 'CLI',
    description: 'Only results about xyzdocs CLI',
    value: 'cli',
  },
];
        ...
        <SearchDialogList
          items={
            query.data !== 'empty' || pageTreeAction
              ? [...(pageTreeAction ? [pageTreeAction] : []), ...(Array.isArray(query.data) ? query.data : [])]
              : null
          }
        />
